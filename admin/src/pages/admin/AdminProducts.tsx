      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-neutral-400 uppercase tracking-widest mt-1">
            Manage your architectural collection
          </p>
        </div>
        <button
                ...
                >
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-4">
                      <img
                        src={product.image}
                        alt={product.name}
                        className="w-12 h-12 rounded bg-neutral-100 object-cover"
                      />
                      <div>
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button className="p-2 hover:bg-white hover:shadow-sm rounded-lg text-neutral-600">
                        <Edit2 size={16} />
                      </button>
                      <button
            ...
            <form onSubmit={handleAddProduct} className="p-6 space-y-4">
              <div className="space-y-1">
                ...
                <input
                  ...
                  placeholder="e.g. Sculptural Armchair"
                />
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <select
                    name="category"
                    className="w-full border-b border-neutral-200 py-2 focus:border-black outline-none text-sm bg-transparent"
                  >
              ...
              <div className="space-y-1">
                ...
                <textarea
                  name="description"
                  required
                  className="w-full border-b border-neutral-200 py-2 focus:border-black outline-none text-sm min-h-[80px]"
                  placeholder="A brief description of the architectural piece..."
                />
              </div>
              ...
              <div className="pt-4 flex gap-3">
                <button
                  type="button"
                  onClick={() => setIsAdding(false)}
                  className="flex-1 py-3 text-[10px] font-bold uppercase tracking-widest border border-neutral-200 hover:bg-neutral-50 transition-colors rounded-lg"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="flex-1 py-3 text-[10px] font-bold uppercase tracking-widest bg-black text-white hover:bg-neutral-800 transition-colors rounded-lg"
                >
                  Create Product
                </button>
              </div>
